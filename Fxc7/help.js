...
│➻ *${prefix}croman Alip dan Friend*
│➻ *${prefix}slide Alip BOT WA*
├───────────────────
│➻ *${prefix}tp 1 - 162*
│➻ *${prefix}ep 1 - 216*
│➻ *${prefix}tahta Alip*
...
│➻ *${prefix}pasangan Alip/Pekora*
│➻ *${prefix}gantengcek Alip*
│➻ *${prefix}cantikcek Pekora*
│➻ *${prefix}artinama Alip*
│➻ *${prefix}persengay Topan*
│➻ *${prefix}pbucin Alip*
│➻ *${prefix}bpfont Alip*
│➻ *${prefix}textstyle Alip*
...
const bottt = (prefix) => {
return `
\`\`\`Untuk Sekarang Bot Hanya Bisa Digunakan Di Group Karna\`\`\` *KALO DI PRIVATE CHAT MAKE NYA GAK NGOTAX*\n\n *Mohon Pengertiannya*
Sekali Lagi Maaf

kalo mau make juga tapi gak ada group, join pakai link group yang ada di profile PEKORA
